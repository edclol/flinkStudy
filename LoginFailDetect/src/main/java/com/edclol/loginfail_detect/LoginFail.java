package com.edclol.loginfail_detect;/**
...
import com.edclol.loginfail_detect.beans.LoginEvent;
import com.edclol.loginfail_detect.beans.LoginFailWarning;
        ...
        public void processElement(LoginEvent value, Context ctx, Collector<LoginFailWarning> out) throws Exception {
            ...
            if ("fail".equals(value.getLoginState())) {
                ...
                if (iterator.hasNext()) {
                    ...
                    if (value.getTimestamp() - firstFailEvent.getTimestamp() <= maxFailTimes) {
                        // 1.1.1 如果在2秒之内，输出报警
