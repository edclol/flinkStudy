package com.edclol.apitest.tableapi.udf;/**
...
import com.edclol.apitest.transform.TransformTest5_RichFunction;
...
public class UdfTest1_ScalarFunction {
    public static void main(String[] args) throws Exception{
        ...
        // 1. 读取数据
        String filePath = TransformTest5_RichFunction.class.getResource("/sensor.txt").toString().replaceFirst("file:/", "");
