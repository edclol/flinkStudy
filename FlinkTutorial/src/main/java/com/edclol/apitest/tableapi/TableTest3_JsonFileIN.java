 ...
 * @Version: 1.0
 */
public class TableTest3_JsonFileIN {
    public static void main(String[] args) throws Exception {
        ...
        // 2. 表的创建：连接外部系统，读取数据
        // 读取文件
        String filePath = TableTest3_JsonFileIN.class.getResource("/json.txt").toString().replaceFirst("file:/", "");
...
/*
        ...
        // 4. 输出到文件
        // 连接外部文件注册输出表
        String outputPath = "D:\\java\\code_java\\flinkStudy\\FlinkTutorial\\src\\main\\resources\\out.txt";
