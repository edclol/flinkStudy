...
import com.edclol.hotitems_analysis.beans.ItemViewCount;
import com.edclol.hotitems_analysis.beans.UserBehavior;
...
public class HotItems {
    public static void main(String[] args) throws Exception {
        ...
        // 2. 读取数据，创建DataStream
        String s = KafkaProducerUtil.class.getResource("/UserBehavior.csv").toString();
        DataStream<String> inputStream = env.readTextFile(s);
